<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="TipoPerg_Listar" Title="Painel Administração" Codebehind="Listar.aspx.cs" %>
        ...
        <tr>
            <td>               
                ...
                <asp:SqlDataSource ID="SqlDataSource_TipoPergList" runat="server" 
                    ...
                    SelectCommand="SELECT * FROM Tipo_Perg" ProviderName="MySql.Data.MySqlClient"></asp:SqlDataSource>
            </td>
        </tr>
    </table>
</asp:Content>
