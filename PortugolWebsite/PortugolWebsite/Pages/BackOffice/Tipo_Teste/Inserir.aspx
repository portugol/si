<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="TipoTeste_Inserir" Title="Painel Administração" Codebehind="Inserir.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table style="background-color:#F0F0F0;">
        <tr>
            ...
            <td colspan="3" style="font-weight: bold; color:#ffffff; font-size: 14px; font-family: Verdana; background-color: #356bb3">Inserir Tipo Teste</td>
        </tr>
        <tr>
