<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="Capitulo_Editar" Title="Painel Administração" Codebehind="Editar.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        ...
        <tr>
            <td>                
                <asp:GridView ID="GrdvEdit_Cap" runat="server" AllowPaging="True" 
                    AllowSorting="True" AutoGenerateColumns="False" 
                    DataSourceID="SqlDataSource_CapEdit" DataKeyNames="Id" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" EnableModelValidation="True" ForeColor="Black" GridLines="Vertical">
                ...
                <asp:SqlDataSource ID="SqlDataSource_CapEdit" runat="server" 
                    ...
                    DeleteCommand="DELETE FROM capitulo WHERE Id = @original_Id AND ((Nome = @original_Nome) OR (Nome IS NULL AND @original_Nome IS NULL)) AND ((Descricao = @original_Descricao) OR (Descricao IS NULL AND @original_Descricao IS NULL))" 
