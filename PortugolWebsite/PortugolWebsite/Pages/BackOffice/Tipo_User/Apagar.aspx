<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" Inherits="TipoUser_Apagar" Title="Painel Administração" Codebehind="Apagar.aspx.cs" %>
    ...
    <table>
        <tr>
            ...
            <td style="font-weight: bold; font-size: 14px; font-family: Verdana; color:#ffffff; background-color: #356bb3">
                Apagar Tipos de Utilizadores</td>
        </tr>
        <tr>
            <td>
                <asp:GridView ID="GrdvApagar_TipoUser" runat="server" AllowPaging="True" 
                    AllowSorting="True" AutoGenerateColumns="False" 
                     BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" EnableModelValidation="True" ForeColor="Black" GridLines="Vertical" DataKeyNames="Id" DataSourceID="SqlDataSource_TipoUserApag">
                ...
                <asp:SqlDataSource ID="SqlDataSource_TipoUserApag" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:ConnectionString_Listar %>" 
                    ...
                    UpdateCommand="UPDATE Tipo_user SET Tipo = @Tipo WHERE Id = @original_Id AND Tipo = @original_Tipo" ProviderName="MySql.Data.MySqlClient">
                    <DeleteParameters>
